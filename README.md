...
management plus a small server-rendered LAN web UI. A single static Go binary,
**stdlib only**, packaged as per-arch `.deb`s on [apt.odio.love](https://apt.odio.love).
